    ...
    <header class="main-menu" role="banner">
      <div class="main-menu__inner">
        ...
        <nav class="main-menu__actions" aria-label="Primary">
          ...
          >
            <svg
              class="main-menu__theme-icon main-menu__theme-icon--sun"
              width="16"
              height="16"
              viewBox="0 0 24 24"
              fill="none"
            ...
            <svg
              class="main-menu__theme-icon main-menu__theme-icon--moon"
              width="16"
              height="16"
              viewBox="0 0 24 24"
              fill="none"
          ...
          >
            ...
            <span class="main-menu__star-count">
              <svg
                class="main-menu__star-glyph"
                width="12"
                height="12"
                viewBox="0 0 16 16"
                fill="currentColor"
